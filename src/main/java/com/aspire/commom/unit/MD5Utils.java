...
public class MD5Utils {
	    ...
	    private static long [] result={A,B,C,D};//存储hash结果，共4×32=128位，初始化值为（幻数的级联）
	     ...
	     */
	    public  static void trans(long[] groups) {
	    ...
	    public  static long FF(long a, long b, long c, long d, long x, long s,
	            long ac) {
	    ...
	    public  static long GG(long a, long b, long c, long d, long x, long s,
	            long ac) {
	    ...
	    public  static long HH(long a, long b, long c, long d, long x, long s,
	            long ac) {
	    ...
	    public  static long II(long a, long b, long c, long d, long x, long s,
	            long ac) {
